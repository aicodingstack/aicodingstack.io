...
export interface EntitySpecificationsProps {
...
/**
 * EntitySpecifications Section
 *
 * Displays technical specifications for AI models including size,
 * context window, max output, and token pricing.
 * Extracted from /models/[slug] page for reusability.
 */
export function EntitySpecifications({ model, translations }: EntitySpecificationsProps) {
  const hasContent =
    model.size ||
    model.contextWindow ||
    model.maxOutput ||
