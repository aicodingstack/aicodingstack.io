...
```bash
node .Codex/skills/benchmark-fetcher/scripts/fetch-benchmarks.mjs
```
...
node .Codex/skills/benchmark-fetcher/scripts/fetch-benchmarks.mjs --benchmarks swebench,terminalBench

# Fetch only LiveCodeBench
node .Codex/skills/benchmark-fetcher/scripts/fetch-benchmarks.mjs --benchmarks liveCodeBench
```
...
```bash
# Update only Codex Sonnet 4.5 and GPT-4o
node .Codex/skills/benchmark-fetcher/scripts/fetch-benchmarks.mjs --models Codex-sonnet-4-5,gpt-4o
```
...
```bash
node .Codex/skills/benchmark-fetcher/scripts/fetch-benchmarks.mjs --dry-run
```
...
```json
{
  "swebench": {
    "websiteModels": {
      "Codex Sonnet 4.5": "Codex-sonnet-4-5",
      "GPT-4o": "gpt-4o",
...
1. **Exact match** (case-sensitive): "Codex Sonnet 4.5" → "Codex-sonnet-4-5"
2. **Case-insensitive match**: "Codex sonnet 4.5" → "Codex-sonnet-4-5"
3. **Fuzzy match** (normalized): "Codex-Sonnet-4.5" → "Codex-sonnet-4-5"
...
✅ Updated: 15 manifests
   • Codex-sonnet-4-5: 3 benchmarks updated
     - sweBench: null → 74.4
