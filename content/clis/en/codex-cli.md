...
Codex CLI supports macOS, Windows, and Linux. Use the platform-specific installation command shown on this page, then launch it with codex from a project directory.
